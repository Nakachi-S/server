...
from .views import AuthRegisterGuest, AuthRegisterHost, GuestInfoPost, GuestInfoGet, HostInfoPost, HostInfoGet, AuthInfoGetView
...
urlpatterns = [
    ...
    path('my_info_get/', AuthInfoGetView.as_view()),
